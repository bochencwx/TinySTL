#ifndef __TINYSTL_RBTREE_H
#define __TINYSTL_RBTREE_H
...
namespace TinySTL {
	...
	struct rbtree_iterator
	{
		...
		rbtree_iterator() : p(0) {}
		rbtree_iterator(node_type* pNode) : p(pNode) {}
		rbtree_iterator(const this_type& x) : p(x.p) {}
